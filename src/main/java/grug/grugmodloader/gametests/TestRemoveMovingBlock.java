...
public class TestRemoveMovingBlock {
    /*
    ```grug
    on_a() {
        ...
        remove_moving_block(block_pos, level)
    ...
    */
    ...
    public static void remove_moving_block(GameTestHelper helper) {
        Grug.resetVariables();
        ...
        GameFunctions.remove_moving_block(blockPosId, levelId);
    ...
    on_a() {
        ...
        remove_moving_block(box, box)

        assert_game_function_error("remove_moving_block(): Expected block_pos, but got boxed_i32")
    ...
    */
    @GameTest(template = GrugModLoader.MODID+":diamond_block")
    public static void remove_moving_block_expected_block_pos(GameTestHelper helper) {
        Grug.resetVariables();
        ...
        GameFunctions.remove_moving_block(box, box);

        helper.assertTrue(Grug.gameFunctionError.equals("remove_moving_block(): Expected block_pos, but got boxed_i32"), "gameFunctionError had the unexpected value '" + Grug.gameFunctionError + "'");
    ...
    on_a() {
        ...
        remove_moving_block(block_pos, box)

        assert_game_function_error("remove_moving_block(): Expected level, but got boxed_i32")
    ...
    */
    @GameTest(template = GrugModLoader.MODID+":diamond_block")
    public static void remove_moving_block_expected_level(GameTestHelper helper) {
        Grug.resetVariables();
        ...
        GameFunctions.remove_moving_block(blockPosId, box);

        helper.assertTrue(Grug.gameFunctionError.equals("remove_moving_block(): Expected level, but got boxed_i32"), "gameFunctionError had the unexpected value '" + Grug.gameFunctionError + "'");
